...
select gender,sum(purchase_amount_usd) as total_revenue from customer
group by gender
...
select round(avg(purchase_amount_usd),2) as avg_spending,
subscription_status, sum(purchase_amount_usd) as total_revenue
from customer
